...
class MoreLikeThisAdapter(
        ...
        inner class MoreLikeThisViewHolder(private val itemMoreLikeThisBinding: ItemMoreLikeThisBinding) : RecyclerView.ViewHolder(itemMoreLikeThisBinding.root) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoreLikeThisViewHolder {
            val view = ItemMoreLikeThisBinding.inflate(LayoutInflater.from(parent.context), parent, false)
